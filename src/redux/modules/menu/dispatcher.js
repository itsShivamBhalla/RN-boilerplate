// Info: Contains Functions Related to Menu Redux state Setters
'use strict';
...
const DispatchMenu = { // Public functions accessible by other modules
  ...
  No return
  *********************************************************************/
  updateMenuDataInRedux: function(redux_dispatcher, menu_deep_data){

    // Update Data in Redux
    return redux_dispatcher({
      type: 'UPDATE_FULL_MENU',
